              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-4 gap-2">
                  ...
                  <div>
                    ...
                    <Input placeholder="Search questions..." value={filters.search || ""} onChange={(e) => { setPage(1); setFilters({ ...filters, search: e.target.value }) }} className="h-8 text-xs bg-gray-800 border-gray-600 text-white focus:ring-1 focus:ring-blue-500/40 w-full"/>
                  </div>
                  <div>
                    <label className="text-xs text-gray-300 opacity-0">Clear</label>
                    <Button variant="ghost" onClick={() => { setFilters({ topics: [], types: [] }); setPage(1) }} className="h-8 px-3 text-xs hover:bg-gray-800 w-full">Clear</Button>
                  </div>
                </div>
