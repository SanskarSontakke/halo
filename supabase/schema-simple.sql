-- Alternative Supabase Schema - Use this if the main schema has issues
-- This version drops and recreates the table completely

-- Drop the existing table completely (WARNING: This will delete all data)
DROP TABLE IF EXISTS questions CASCADE;

-- Create the questions table with correct schema
...
('q3', 'Photosynthesis occurs in the ____ of plant cells.', 'chloroplasts', 1, '7th Grade', 'Biology', 'Science', 'fill_in_blanks', NULL, NULL),
('q4', 'Match the pairs', 'A-1, B-2, C-3, D-4', 2, '7th Grade', 'Chemistry Basics', 'Science', 'match_pairs', NULL, NULL),
('q5', 'Define photosynthesis in one or two lines.', 'Photosynthesis is the process by which plants convert sunlight, carbon dioxide, and water into glucose and oxygen.', 2, '7th Grade', 'Biology', 'Science', 'short_answer', NULL, NULL),
('q6', 'Explain the water cycle briefly.', 'The water cycle is the continuous movement of water through evaporation, condensation, and precipitation.', 3, '7th Grade', 'Environment', 'Science', 'short_answer', NULL, NULL),
('q7', 'Match the pairs', 'A-1, B-2, C-3, D-4, E-5', 2, '7th Grade', 'Planets', 'Science', 'match_pairs', NULL, NULL),
...
('q9', 'The Great Wall of China is located in ____.', 'China', 1, '6th Grade', 'World History', 'Social Studies', 'fill_in_blanks', NULL, NULL),
('q10', 'Match the countries with their capitals', 'A-1, B-2, C-3, D-4', 2, '6th Grade', 'Geography', 'Social Studies', 'match_pairs', NULL, NULL);
